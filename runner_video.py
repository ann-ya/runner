...
def obstacle_movement(obstacle_list):
    if obstacle_list:
        for obstacle_rect in obstacle_list:
            ...
            else: screen.blit(fly_surf,obstacle_list)

            screen.blit(snail_surf,obstacle_rect)

        obstacle_list = [obstacle for obsactle in obstacle_list if obsactle.x > -100]
...
score_surf = game_font.render('My game', False, 'Purple')
score_rect = score_surf.get_rect(center = (400, 50))
